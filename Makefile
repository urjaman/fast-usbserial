...
LDFLAGS += -Wl,--section-start,.data=0x800280
LDFLAGS += $(EXTMEMOPTS)
...
build elf hex eep lss sym  clean          \
clean_list program dfu flip flip-ee dfu-ee      \
